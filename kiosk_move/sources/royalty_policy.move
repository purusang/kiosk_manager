module marketplace::royalty_policy {
    use sui::sui::SUI;
    ...
    public fun get_policy(witness: ROYALTY_POLICY, ctx: &mut TxContext): (TransferPolicy<Sword>, TransferPolicyCap<Sword>) {
